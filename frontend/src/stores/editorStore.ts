  ...
  persist(
    (set, get) => ({
      ...
      resetProject: () => {
        ...
        useSpriteStore.getState().resetSpriteStore();
    ...
    }),
    {
      ...
      merge: (persisted: any, current) => ({
        ...current,
        ...(persisted || {}),
        spriteWorkspaces: persisted?.spriteWorkspaces ? new Map(persisted.spriteWorkspaces) : current.spriteWorkspaces,
      }),
    },
  ),
);
