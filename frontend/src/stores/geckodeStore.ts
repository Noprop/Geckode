  ...
  persist(
    ...
    }),
    {
      ...
      partialize: (state) => (
        ...
        tileTextures: state.tileTextures,
        tilesetTextures: state.tilesetTextures,
        animationTextures: state.animationTextures,
        backgroundTextures: state.backgroundTextures,
