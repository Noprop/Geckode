...
const SpriteEditor = () => {
  ...
  // --- Custom hooks ---
  const { cellSize, zoomIn, zoomOut, canZoomIn, canZoomOut, canvasContainerRef, scrollContainerRef } = useCanvasZoom(
    gridWidth,
    gridHeight,
    { zoomStep: 10 },
  );
  ...
  const handlePrimaryAction = async () => {
    ...
    showSnackbar(`Successfully created ${newTextureName}!`, 'success');
    closeSpriteModal();
  };
