...
export const ManageMembers = ({ org, setOrg, user, userPerm }: Props) => {
        ...
        actions={[
          {
            ...
            canUse: (a) => ['admin', 'manage'].includes(userPerm), // WILL NEED TO CHANGE TO PROPER PERMISSIONS!!!
          },
        ]}
        extras={
          <>
            <Button
              ...
              disabled={!['admin', 'invite', 'manage'].includes(userPerm)}
            >
              Invite Users
            </Button>
          </>
