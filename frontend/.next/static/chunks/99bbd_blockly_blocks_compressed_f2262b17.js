...
"[project]/frontend/node_modules/.pnpm/blockly@12.3.1/node_modules/blockly/blocks_compressed.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
(function(root, factory) {
    ...
    var blocks$$module$build$src$blocks$text = $.createBlockDefinitionsFromJsonArray$$module$build$src$core$common([
            ...
            args0: [
                ...
                },
                {
                    ...
                    options: [
                        ...
                        [
                            "%{BKY_TEXT_CHARAT_FIRST}",
                            "FIRST"
                        ],
                        [
                            "%{BKY_TEXT_CHARAT_LAST}",
                            "LAST"
                        ],
                        [
                            "%{BKY_TEXT_CHARAT_RANDOM}",
                            "RANDOM"
                        ]
                    ]
                }
        ...
        init: function() {
            this.WHERE_OPTIONS_1 = [
                [
                    $.Msg$$module$build$src$core$msg.TEXT_GET_SUBSTRING_START_FROM_START,
                    "FROM_START"
                ],
                [
        ...
        updateAt_: function(a, b) {
            ...
            a === 2 && $.Msg$$module$build$src$core$msg.TEXT_GET_SUBSTRING_TAIL && (this.removeInput("TAIL", !0), this.appendDummyInput("TAIL").appendField($.Msg$$module$build$src$core$msg.TEXT_GET_SUBSTRING_TAIL));
    ...
    blocks$$module$build$src$blocks$text.text_trim = {
        init: function() {
            const a = [
                [
                    $.Msg$$module$build$src$core$msg.TEXT_TRIM_OPERATOR_BOTH,
                    "BOTH"
                ],
                [
                    $.Msg$$module$build$src$core$msg.TEXT_TRIM_OPERATOR_LEFT,
                    "LEFT"
                ],
                [
                    $.Msg$$module$build$src$core$msg.TEXT_TRIM_OPERATOR_RIGHT,
                    "RIGHT"
                ]
            ];
    ...
    blocks$$module$build$src$blocks$text.text_prompt_ext = Object.assign({}, PROMPT_COMMON$$module$build$src$blocks$text, {
        init: function() {
            var a = [
                [
                    $.Msg$$module$build$src$core$msg.TEXT_PROMPT_TYPE_TEXT,
                    "TEXT"
                ],
                [
    ...
    var blocks$$module$build$src$blocks$procedures = {}, PROCEDURE_DEF_COMMON$$module$build$src$blocks$procedures = {
        ...
        domToMutation: function(a) {
            ...
            for(let c = 0, d; d = a.childNodes[c]; c++)if (d.nodeName.toLowerCase() === "arg") {
                ...
                b !== null ? this.argumentVarModels_.push(b) : console.log('Failed to create a variable named "'.concat(e, '", ignoring.'));
            }
            this.updateParams_();
    ...
    var ProcedureArgumentField$$module$build$src$blocks$procedures = class extends $.FieldTextInput$$module$build$src$core$field_textinput {
        ...
        validator_: function(a) {
            ...
            if (!a) return null;
            const d = (b.workspace.targetWorkspace || b.workspace).getAllBlocks(!1), e = a.toLowerCase();
    ...
    var DISABLED_PROCEDURE_DEFINITION_DISABLED_REASON$$module$build$src$blocks$procedures = "DISABLED_PROCEDURE_DEFINITION", PROCEDURE_CALL_COMMON$$module$build$src$blocks$procedures = {
        ...
        onchange: function(a) {
            if (this.workspace && !this.workspace.isFlyout && a.recordUndo) if (a.type === $.BLOCK_CREATE$$module$build$src$core$events$events && a.ids.includes(this.id)) {
                ...
                if (c) c.isEnabled() || (this.setDisabledReason(!0, DISABLED_PROCEDURE_DEFINITION_DISABLED_REASON$$module$build$src$blocks$procedures), this.setWarningText($.Msg$$module$build$src$core$msg.PROCEDURES_CALL_DISABLED_DEF_WARNING.replace("%1", b)));
                else {
    ...
    var UNPARENTED_IFRETURN_DISABLED_REASON$$module$build$src$blocks$procedures = "UNPARENTED_IFRETURN", PROCEDURES_IFRETURN$$module$build$src$blocks$procedures = {
        ...
        onchange: function(a) {
            if (!(this.workspace.isDragging && this.workspace.isDragging() || a.type !== $.BLOCK_MOVE$$module$build$src$core$events$events && a.type !== $.BLOCK_CREATE$$module$build$src$core$events$events)) {
                ...
                a ? (b.type === "procedures_defnoreturn" && this.hasReturnValue_ ? (this.removeInput("VALUE"), this.appendDummyInput("VALUE").appendField($.Msg$$module$build$src$core$msg.PROCEDURES_DEFRETURN_RETURN), this.hasReturnValue_ = !1) : b.type !== "procedures_defreturn" || this.hasReturnValue_ || (this.removeInput("VALUE"), this.appendValueInput("VALUE").appendField($.Msg$$module$build$src$core$msg.PROCEDURES_DEFRETURN_RETURN), this.hasReturnValue_ = !0), this.setWarningText(null)) : this.setWarningText($.Msg$$module$build$src$core$msg.PROCEDURES_IFRETURN_WARNING);
    ...
    var loopTypes$$module$build$src$blocks$loops = new Set([
        ...
        "controls_for",
        "controls_whileUntil"
    ]), CONTROL_FLOW_NOT_IN_LOOP_DISABLED_REASON$$module$build$src$blocks$loops = "CONTROL_FLOW_NOT_IN_LOOP", CONTROL_FLOW_IN_LOOP_CHECK_MIXIN$$module$build$src$blocks$loops = {
    ...
    $.registerMutator$$module$build$src$core$extensions("controls_if_mutator", CONTROLS_IF_MUTATOR_MIXIN$$module$build$src$blocks$logic, null, [
        "controls_if_elseif",
        "controls_if_else"
    ]);
    ...
    var LOGIC_COMPARE_ONCHANGE_MIXIN$$module$build$src$blocks$logic = {
        onchange: function(a) {
            this.prevBlocks_ || (this.prevBlocks_ = [
                null,
                null
            ]);
    ...
    var LISTS_INDEXOF$$module$build$src$blocks$lists = {
        init: function() {
            var a = [
                [
                    $.Msg$$module$build$src$core$msg.LISTS_INDEX_OF_FIRST,
                    "FIRST"
                ],
                [
                    $.Msg$$module$build$src$core$msg.LISTS_INDEX_OF_LAST,
                    "LAST"
                ]
            ];
    ...
    var LISTS_GETINDEX$$module$build$src$blocks$lists = {
        init: function() {
            var a = [
                [
                    $.Msg$$module$build$src$core$msg.LISTS_GET_INDEX_GET,
                    "GET"
                ],
                [
                ...
                [
                    $.Msg$$module$build$src$core$msg.LISTS_GET_INDEX_REMOVE,
                    "REMOVE"
                ]
            ];
            this.WHERE_OPTIONS = [
                ...
                [
                    $.Msg$$module$build$src$core$msg.LISTS_GET_INDEX_FROM_END,
                    "FROM_END"
                ],
                [
                    $.Msg$$module$build$src$core$msg.LISTS_GET_INDEX_FIRST,
                    "FIRST"
                ],
                [
            ...
            this.setTooltip(()=>{
                ...
                if (c === "FROM_START" || c === "FROM_END") d += "  " + (c === "FROM_START" ? $.Msg$$module$build$src$core$msg.LISTS_INDEX_FROM_START_TOOLTIP : $.Msg$$module$build$src$core$msg.LISTS_INDEX_FROM_END_TOOLTIP).replace("%1", this.workspace.options.oneBasedIndex ? "#1" : "#0");
                return d;
            });
        },
        mutationToDom: function() {
    ...
    var LISTS_SETINDEX$$module$build$src$blocks$lists = {
        init: function() {
            var a = [
                [
                    $.Msg$$module$build$src$core$msg.LISTS_SET_INDEX_SET,
                    "SET"
                ],
                [
                    $.Msg$$module$build$src$core$msg.LISTS_SET_INDEX_INSERT,
                    "INSERT"
                ]
            ];
            this.WHERE_OPTIONS = [
    ...
    var LISTS_GETSUBLIST$$module$build$src$blocks$lists = {
        init: function() {
            ...
            this.WHERE_OPTIONS_2 = [
                ...
                [
                    $.Msg$$module$build$src$core$msg.LISTS_GET_SUBLIST_END_LAST,
                    "LAST"
                ]
            ];
            ...
            this.jsonInit({
                ...
                args0: [
                    ...
                    },
                    {
                        ...
                        options: [
                            [
                                "%{BKY_LISTS_SORT_ORDER_ASCENDING}",
                                "1"
                            ],
                            [
                                "%{BKY_LISTS_SORT_ORDER_DESCENDING}",
                                "-1"
                            ]
                        ]
                    },
        ...
        init: function() {
            const a = $.fromJson$$module$build$src$core$field_registry({
                ...
                options: [
                    ...
                    [
                        $.Msg$$module$build$src$core$msg.LISTS_SPLIT_TEXT_FROM_LIST,
                        "JOIN"
                    ]
                ]
            });
...
//# sourceMappingURL=99bbd_blockly_blocks_compressed_f2262b17.js.map